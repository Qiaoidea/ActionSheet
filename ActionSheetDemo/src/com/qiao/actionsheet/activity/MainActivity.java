...
public class MainActivity extends Activity implements OnClickListener{
    ...
    public void back(){
		...
		final com.qiao.actionsheet.ios6.ActionSheet actionSheet = new com.qiao.actionsheet.ios6.ActionSheet(MainActivity.this);
		actionSheet.show("确定要退出么？",new String[]{"退出" },new com.qiao.actionsheet.ios6.ActionSheet.Action1<Integer>(){
			@Override
